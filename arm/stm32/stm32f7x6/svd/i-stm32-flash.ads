...
package Interfaces.STM32.FLASH is
   ...
   subtype ACR_ARTEN_Field is Interfaces.STM32.Bit;
   subtype ACR_ARTRST_Field is Interfaces.STM32.Bit;
   ...
   subtype OPTCR_WWDG_SW_Field is Interfaces.STM32.Bit;
   subtype OPTCR_IWDG_SW_Field is Interfaces.STM32.Bit;
   ...
   subtype OPTCR_nWRP_Field is Interfaces.STM32.Byte;
   subtype OPTCR_IWDG_STDBY_Field is Interfaces.STM32.Bit;
   subtype OPTCR_IWDG_STOP_Field is Interfaces.STM32.Bit;
   ...
   type OPTCR_Register is record
      ...
      --  User option bytes
      WWDG_SW        : OPTCR_WWDG_SW_Field := 16#0#;
      --  User option bytes
      IWDG_SW        : OPTCR_IWDG_SW_Field := 16#1#;
      --  User option bytes
      ...
      --  unspecified
      Reserved_24_29 : Interfaces.STM32.UInt6 := 16#F#;
      --  Independent watchdog counter freeze in standby mode
      IWDG_STDBY     : OPTCR_IWDG_STDBY_Field := 16#0#;
      --  Independent watchdog counter freeze in Stop mode
      IWDG_STOP      : OPTCR_IWDG_STOP_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype OPTCR1_BOOT_ADD_Element is Interfaces.STM32.UInt16;
